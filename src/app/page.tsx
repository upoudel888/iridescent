      ...
      <div className="container flex max-w-screen-xl flex-row flex-wrap-reverse items-center justify-between gap-8 self-center px-4 py-14 sm:px-8  md:gap-0">
        <div className="flex h-full w-full flex-col items-center justify-center gap-4 text-center md:w-5/12 md:items-start md:text-left">
          ...
          <h2 className="flex flex-col">
            ...
            <span className="font-barlow animated-text mt-2 text-3xl font-bold lg:text-4xl xl:text-5xl">
              Take Flight
            </span>
          </h2>
          <article className="sm:text-lg md:w-5/6 whitespace-pre-line">
            {welcomePoem}
          </article>
          <Button title="Start Reading" size={"lg"} className="flex flex-col">
            <Link
              href={"/poems"}
        ...
        <div className="flex w-11/12 items-center justify-center md:justify-end md:h-full md:w-7/12">
          <Image
            src="/images/hero.png"
